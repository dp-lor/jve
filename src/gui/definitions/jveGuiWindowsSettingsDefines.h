...
#ifndef JVEGUIWINDOWSSETTINGSDEFINES_H
#define JVEGUIWINDOWSSETTINGSDEFINES_H


// main window
#define JVE_GUI_SETTINGS_MAIN_WINDOW_GEOMETRY         "mainWindow/geometry"
#define JVE_GUI_SETTINGS_MAIN_WINDOW_STATE            "mainWindow/state"
...
#define JVE_GUI_SETTINGS_OPEN_PROJECT_DIALOG_STATE  "openProjectDialog/state"
#define JVE_GUI_SETTINGS_SAVE_PROJECT_DIALOG_STATE  "saveProjectDialog/state"


// add project sources dialogs
#define JVE_GUI_SETTINGS_ADD_PROJECT_SOURCES_MEDIA_ITEMS_DIALOG_STATE           "addProjectSourcesMediaItemsDialog/state"
#define JVE_GUI_SETTINGS_ADD_PROJECT_SOURCES_IMAGES_SEQUENCE_ITEM_DIALOG_STATE  "saveProjectSourcesImagesSequenceItemDialog/state"


#endif // JVEGUIWINDOWSSETTINGSDEFINES_H
