...
void NorwegianWoodStyle::polish(QPalette &palette)
{
    ...
    brush.setColor(Qt::black/*brush.color().dark()*/);
    ...
    case PE_PanelButtonCommand:
        {
            ...
            QColor slightlyOpaqueBlack(0, 0, 0, 63);
            QColor semiTransparentWhite(0, 0, 0, 127 + delta);
            QColor semiTransparentBlack(255, 255, 255, 127 - delta);
